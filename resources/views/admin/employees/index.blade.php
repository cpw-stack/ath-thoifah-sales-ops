...
<div class="flex flex-col sm:flex-row justify-between sm:items-center mb-6 gap-4">
    ...
    <a href="{{ route('admin.employees.create') }}" class="btn">+ Tambah Salesman</a>
</div>
...
<div class="card overflow-hidden">
    ...
    <div class="p-4 flex flex-col md:flex-row items-center justify-between gap-4 border-b" style="border-color:var(--border); background:var(--paper-dim);">
        <form method="GET" action="{{ route('admin.employees.index') }}" class="relative w-full md:max-w-xs">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama atau kode salesman..." class="w-full pr-9">
        ...
        <div class="flex items-center gap-2 text-xs" style="color:var(--slate);">
            <span class="hidden md:inline">Total Salesman:</span>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50" style="border-color:var(--border);">
                    ...
                    <td class="p-4 text-sm">
                        @if($employee->salesArea)
                            {{ $employee->salesArea->name }}
                        @else
                            <span class="text-gray-400">Belum diassign</span>
                        @endif
                    </td>
                    <td class="p-4">
                ...
                @empty
                <tr>
                    <td colspan="5" class="p-8 text-center" style="color:var(--slate);">
