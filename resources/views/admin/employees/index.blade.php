...
<div class="card p-5 mb-4 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-5">
    ...
    <div class="flex flex-col gap-2 w-full md:max-w-xs">
        <label class="text-xs font-bold uppercase tracking-wider" style="color:var(--slate);">Cari Salesman</label>
        <div class="relative">
            <form method="GET" action="{{ route('admin.employees.index') }}" class="w-full">
